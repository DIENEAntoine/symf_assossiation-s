...
class RegistrationController extends AbstractController
{
    ...
    public function register(
        ...
        ): Response
        {
            ...
            if ($form->isSubmitted() && $form->isValid()) 
            {
                ...
                $sendEmailService->send([
                    "sender_email"    => "Kara-assos@gmail.com",
                    "sender_name"     => "Kara Aidara",
                    "recipient_email" => $user->getEmail(),
                    "subject"         => "Vérification de votre compte sur le site de Kara-Assos",
        ...
        public function emailVerif(User $user, string $token, UserRepository $userRepository): Response
        {
            ...
            {
                $this->addFlash('success', 'Votre compte a dèjà été vérifié! Veuiller vous connecter.');
                return $this->redirctToRoute("visitor.welcome.index");
            }
            ...
            if ( new \DateTimeImmutable('now') > $user->getExpiresAt() ) 
            {
                ...
                throw new CustomUserMessageAccountStatusException("Votre délai de vérification du compte est dépassé depuis le : $deadline. Veillez vous réinscrire.");
            }
